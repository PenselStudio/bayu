////////////////Data
Template.adjustApp.templateHolder = function() {
  var app = Session.get('currentApp');
  switch(app){
    case('grid'):
      return Template['adjustGrid'];
      break;
    default:
      return null;
      break;
...
//////////////Created
Template.adjustAdmin.created = function(){
...
//////////////Rendered
Template.adjustAdmin.rendered = function(){
  //$('div.form').hide();
  $('div.suggestion').hide();
