////////////////Data
Template.receiveApp.templateHolder = function() {
  var app = Session.get('currentApp');
  switch(app){
    case('grid'):
      return Template['receiveGrid'];
      break;
    default:
      return null;
      break;
...
//////////////Created
Template.receiveAdmin.created = function(){
...
//////////////Rendered
Template.receiveAdmin.rendered = function(){
  //$('div.form').hide();
  $('div.suggestion').hide();
...
Template.receiveSubmenu.events = {
